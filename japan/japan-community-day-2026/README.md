Kubernetes Upstream Training in Japan at [Japan Community Day 2026](https://events.linuxfoundation.org/kubecon-cloudnativecon-japan/co-located-events/japan-community-day/)

Welcome to Kubernetes Upstream Training!!

This is the location of [Kubernetes Upstream Training in Japan](https://ocgroups.dev/cncf/group/bqd97by/event/rhvmu2v) (July 28th 2026) activities.

ここは、[CNCJ](https://community.cncf.io/cloud-native-community-japan/)のサブチャプターであるKubernetes Upstream Training Japan が [Japan Community Day 2026](https://events.linuxfoundation.org/kubecon-cloudnativecon-japan/co-located-events/japan-community-day/) で 2026/7/28 に開催するトレーニングのためのページです。
このトレーニングの続編として、Doc Sprint （ドキュメント貢献体験会）も同時に行います。

[イベント概要と参加登録はこちら](https://ocgroups.dev/cncf/group/bqd97by/event/rhvmu2v)
